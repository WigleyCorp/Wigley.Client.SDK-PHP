...
//    }
    ...
    public function setPaymentInstrumentInput($value)
    {
        ...
        if (!($value instanceof PaymentInstrumentInput)) {
            throw new \WigleyPay\Sdk\Exception\InvalidArgumentException('PaymentInstrumentInput debe ser del tipo \\WigleyPay\\Sdk\\Models\\PaymentInstrumentInput o un array compatible.');
        }

...
class IntrumentCallback extends ModelsBase
{
    ...
    public function setPaymentInstrument($value)
    {
        ...
        if (!($value instanceof PaymentInstrument)) {
            throw new \WigleyPay\Sdk\Exception\InvalidArgumentException('PaymentInstrument debe ser del tipo \\WigleyPay\\Sdk\\Models\\PaymentInstrument o un array compatible.');
        }

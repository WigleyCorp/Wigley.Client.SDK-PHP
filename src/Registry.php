    ...
    */
    static public function add($object, $name = null) {
        ...
        if (isset(self::$_store[$name])) {
            throw new Exception\WigleyPayException(sprintf("Ya existe un objeto registrado bajo el nombre '%s'.", $name));
        }
    ...
    */
    static public function get($name) {
        if (!self::contains($name)) {
            throw new Exception\WigleyPayException("El objeto no existe en el registro.");
        }
